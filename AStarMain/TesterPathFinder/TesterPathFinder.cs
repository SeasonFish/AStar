...
namespace AStar
{
    ...
    /// テストを動かすパスファインダーです。
    /// </summary>
    public sealed class TesterPathFinder : IPathFinder
    {
        /// <summary>
        /// 起点から終点までの最短経路を算出します。
        /// </summary>
        ...
        /// </returns>
        public IEnumerable<Position> FindPath(int width, int height, Position startPoint, Position endPoint, ISet<Position> obstacles)
        {
